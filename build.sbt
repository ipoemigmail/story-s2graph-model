...
lazy val commonSettings = Seq(
  ...
  unmanagedClasspath in Compile += new File(
    "/Users/ben.jeong/Develop/Works/Kakao/Story/story-spark-job2/project-submodule/data-common/target/scala-2.11/classes"),
...
lazy val `s2graph-model` = (project in file("s2graph-model")).settings(
  inThisBuild(
    List(
      organization := "com.kakao.story",
      scalaVersion := "2.12.7",
      version := "0.1.0",
...
lazy val `story-s2graph-model` = (project in file("."))
  ...
  .settings(
    ...
    skip in packageDoc := true,
    skip in packageSrc := true,
